...
export function CircularRingBufferModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      <div className="w-full max-w-xl rounded-xl border border-[var(--surface-border)] bg-[var(--surface-canvas)] p-5 shadow-2xl font-mono text-xs max-h-[90vh] flex flex-col">
        {/* Header */}
        ...
        <div className="space-y-3 my-4">
          <div className="rounded-lg border border-[var(--surface-border)] bg-[var(--surface-panel)] p-4 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="rounded bg-[var(--surface-subtle)] px-2 py-0.5 text-[10px] text-[var(--text-secondary)] font-bold">
            ...
            <div>
              <div className="flex justify-between text-xs pb-1 font-bold">
                <span className="text-[var(--text-primary)]">{usedGb.toFixed(1)} GB Used</span>
                <span className="text-[var(--text-secondary)]">64.0 GB Capacity (72h Horizon)</span>
              </div>
              <div className="w-full h-3 bg-[var(--surface-canvas)] rounded border border-[var(--surface-border)] overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-emerald-500 to-[#2563eb] transition-all duration-300"
            ...
            <div className="grid grid-cols-3 gap-2 pt-1 text-[11px]">
              <div className="rounded border border-[var(--surface-border)] bg-[var(--surface-canvas)] p-2 text-center">
                <span className="text-[var(--text-secondary)]">Buffered Clips</span>
                <p className="font-bold text-[var(--text-primary)] text-sm mt-0.5">{totalClips}</p>
              </div>
              <div className="rounded border border-[var(--surface-border)] bg-[var(--surface-canvas)] p-2 text-center">
                <span className="text-[var(--text-secondary)]">IMU/GPS Logs</span>
                <p className="font-bold text-[var(--text-primary)] text-sm mt-0.5">21,480 pkts</p>
              </div>
              <div className="rounded border border-[var(--surface-border)] bg-[var(--surface-canvas)] p-2 text-center">
                <span className="text-[var(--text-secondary)]">Retention Window</span>
          ...
          <div className="rounded-lg border border-[var(--surface-border)] bg-[var(--surface-panel)] p-3 space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-semibold text-[var(--text-secondary)] uppercase">
            ...
            {isSyncing && (
              <div className="space-y-1.5 pt-2 border-t border-[var(--surface-border)]">
                ...
                <div className="w-full h-2 bg-[var(--surface-canvas)] rounded border border-[var(--surface-border)] overflow-hidden">
                  <div
        ...
        {/* Footer Actions */}
        <div className="flex items-center justify-end gap-2 pt-3 border-t border-[var(--surface-border)] shrink-0">
          ...
          <Button
            ...
            disabled={isSyncing}
            className="bg-[#2563eb] text-[var(--text-primary)] hover:bg-[var(--surface-subtle)] font-bold"
          >
